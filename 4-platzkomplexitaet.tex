...
\begin{definition}
    ...
    \\
    % TODO sqcup soll A enthalten
    % http://tex.stackexchange.com/questions/125438/place-symbol-inside-of-bigsqcup
    Die Maschine wird mit Kellerinhalt $\sqcup \overline{A}$ gestartet und hält per Definition, wenn der Keller leer wird, d.h. wenn $A$ gePOPt wird.
...
\begin{beweis}
    ...
    \begin{itemize}
        ...
        \\
        % TODO sqcup soll x enthalten
        $b'$ ist die Bandkonfiguration, die erreicht wird, wenn man $T$ in $b$ und mit Kellerinhalt $\sqcup x$ startet und so lange rechnet, bis $X$ zum ersten Mal gePOPt wird. 
